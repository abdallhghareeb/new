...
//   return DateFormat(
//           'MMM d, y hh:mm a',
//           Provider.of<LanguageProvider>(Constants.globalContext(), listen: false).appLocal.languageCode).format(dateTime);
// }
...
//   }
//   // return '${LanguageProvider.translate('ad', 'ago')} ${getTimeNumber(years, month, days, hours, min, sec)}${getTimeChar(years, month, days, hours, min, sec)}';
// }
...
String getTimeChar(int year, int month, int day, int h, int m, int s) {
  // if (year != 0) {
  //   return LanguageProvider.translate('ad', 'year');
  // } else if (month != 0) {
  //   return LanguageProvider.translate('ad', 'month');
  // } else if (day != 0) {
  //   return LanguageProvider.translate('ad', 'day');
  // } else if (h != 0) {
  //   return LanguageProvider.translate('ad', 'hour');
  // } else if (m != 0) {
  //   return LanguageProvider.translate('ad', 'min');
  // } else if (s != 0) {
  //   return LanguageProvider.translate('ad', 'sec');
  // }
  return '';
}
